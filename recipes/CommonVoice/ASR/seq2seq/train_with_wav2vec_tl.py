...
if __name__ == "__main__":
    ...
    asr_pt = sb.pretrained.EncoderDecoderASR.from_hparams(
        source=hparams["pretrained_model"],
        savedir=hparams["pretrained_model_savedir"],
    )
    ...
    hparams["emb"].load_state_dict(asr_pt.mods.decoder.emb.state_dict())
    hparams["emb"].train()
    ...
    hparams["dec"].load_state_dict(asr_pt.mods.decoder.dec.state_dict())
    hparams["dec"].train()
